...
function printQuote() {
  ...
  var quoteCombined = quotes[quoteNumber];
  var html = "";
  html += '<p class="quote">' + quoteCombined.quote + '</p>';
  html += '<p class="source">' + quoteCombined.source;
  if (quoteCombined.citation){
    html += '<span class="citation">';
    html += '<a href="' + quoteCombined.link + '" target="_blank">' + quoteCombined.citation + '</a></span>';
  }
  if (quoteCombined.year){
    html += '<span class="year">' + quoteCombined.year + '</span>';
  }  
  html += '</p>';
